...
public class BirchEssenceBucketBlock extends HorizontalDirectionalBlock {
    public static final MapCodec<BirchEssenceBucketBlock> CODEC = simpleCodec(BirchEssenceBucketBlock::new);
    public static final DirectionProperty FACING = BlockStateProperties.HORIZONTAL_FACING;

    public BirchEssenceBucketBlock(Properties properties) {
        super(properties);
    }
