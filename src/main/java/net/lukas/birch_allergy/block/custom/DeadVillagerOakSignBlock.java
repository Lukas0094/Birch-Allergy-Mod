...
public class DeadVillagerOakSignBlock extends HorizontalDirectionalBlock {
    public static final MapCodec<DeadVillagerOakSignBlock> CODEC = simpleCodec(DeadVillagerOakSignBlock::new);
    public static final DirectionProperty FACING = BlockStateProperties.HORIZONTAL_FACING;

    public DeadVillagerOakSignBlock(Properties properties) {
        super(properties);
    }
